...
namespace SimpleHashing.Other
{
    public class ZeHesh
    {
        ...
        {
            return new ZeHashBase().ComputeHash(data);
        }
    }

    internal class ZeHashBase
    {
        private byte[] X;
        ...
        18, 190, 78, 196, 214, 218, 158, 222, 73, 160, 251, 245, 142, 187, 47, 238,
        ...
        private void Transform()
        {
            ...
            for (int j = 0; j < 18; j++)
            {
                ...
                tIndex = (byte)(tIndex + j);
            }
        }

        private void PadBuffer()
        {
            int padLen = 16 - buffer.Length;
            for (int i = 0; i < padLen; i++)
            {
                buffer[buffer.Length + i] = (byte)padLen;
            }
