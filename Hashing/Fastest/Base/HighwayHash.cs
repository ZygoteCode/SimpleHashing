...
namespace SimpleHashing.Fastest.Base
{
    ...
    internal abstract class HighwayHash : Hash
    {
        #region Constants
    ...
    internal sealed class HighwayHash64 : HighwayHash
    {
        #region Properties
        /// <inheritdoc/>
        [ExcludeFromCodeCoverage]
    ...
    internal sealed class HighwayHash128 : HighwayHash
    {
        #region Properties
        /// <inheritdoc/>
        [ExcludeFromCodeCoverage]
    ...
    internal sealed class HighwayHash256 : HighwayHash
    {
        #region Properties
        /// <inheritdoc/>
        [ExcludeFromCodeCoverage]
